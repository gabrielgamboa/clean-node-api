...
const makeEmailValidator = (): EmailValidator => {
  class EmailValidatorStub implements EmailValidator { // retorno mockado
...
const makeAddAccount = (): AddAccount => {
  class AddAccountStub implements AddAccount { // retorno mockado
